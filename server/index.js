...
require('dotenv').config(); // Asegurarnos de que carga las variables de entorno
...
// Función para ChatGPT con reintentos
async function getChatGPTResponse(message, retryCount = 0) {
  try {
    ...
    // Si es error 429 y no hemos intentado más de 3 veces, esperar y reintentar
    ...
    // Si es error 429, dar un mensaje más amigable
...
// Agregar la función obtenerRespuesta
function obtenerRespuesta(mensaje) {
  ...
  const respuestas = {
    ...
    informacionPersonal: {
      ...
      response: "Andrés Amuchástegui es un desarrollador Full Stack de 29 años, originario de Córdoba, Argentina. Combina su formación en desarrollo web con un background en artes audiovisuales."
    },

    experiencia: {
      keywords: ["experiencia", "trabajado", "laboral", "trabajo", "profesional"],
      response: "Andrés cuenta con experiencia significativa en desarrollo web. Actualmente trabaja en XCONS como desarrollador Full Stack, donde utiliza tecnologías como React y Node.js."
    },
    
    habilidades: {
      keywords: ["sabe", "hacer", "habilidades", "tecnologías", "tecnologia", "stack", "herramientas"],
      response: "Las principales habilidades técnicas de Andrés incluyen:\n- Frontend: React, JavaScript, HTML5, CSS3\n- Backend: Node.js, Express\n- Bases de datos: MongoDB\n- Herramientas: Git, GitHub\n- Diseño: Conocimientos en diseño audiovisual"
    },

    estudios: {
      keywords: ["estudios", "estudió", "formación", "formacion", "educación", "educacion", "carrera"],
      response: "Andrés tiene formación en Desarrollo Web Full Stack y un background en Artes Audiovisuales. Constantemente se mantiene actualizado en las últimas tecnologías web."
    },
    ...
    fueraDeContexto: {
      response: "Lo siento, esa pregunta está fuera de mi conocimiento. ¿Te gustaría saber algo específico sobre la experiencia profesional, proyectos o habilidades de Andrés?"
    }
  };
  ...
  // Si no encuentra coincidencias específicas pero menciona a Andrés
...
io.on('connection', (socket) => {
  ...
  // Agregar un nuevo evento para cambio de chat
