                ...
                <footer className='footer text-white py-4 '>
                    <div className='container'>
                        ...
                        <div className='botones-logos-texto d-flex justify-content-between'>
                            ...
                            <div className='red-tres px-3'><a target='_blank' href='https://www.linkedin.com/in/andr%C3%A9s-amuch%C3%A1stegui-3b47ab21b/'>
                                ...
                                <div className='red-dos px-3'><a target='_blank' href='https://github.com/AndyAmu'>
                                ...
                                <div className='red-tres px-3'><a target='_blank' href='https://www.youtube.com/channel/UCB5rjrpmaLWupWRMw4KV7mg'>
