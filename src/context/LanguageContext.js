...
export const translations = {
  en: {
    ...
    introduction: "Full Stack Developer focused on high-performance web and mobile experiences. Specialized in e-commerce architectures and AI integration to create scalable, innovative, and valuable solutions.",
  ...
  es: {
    ...
    introduction: "Desarrollador Full Stack orientado a experiencias web y móviles de alto rendimiento. Especializado en arquitecturas e-commerce e integración de IA para crear soluciones escalables, innovadoras y de valor.",
